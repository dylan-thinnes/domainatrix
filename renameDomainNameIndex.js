...
db.sRun("INSERT INTO domains(name, dns, dnsLastUpdate, ping, pingLastUpdate, http, httpLastUpdate) SELECT domainName, dns, dnsLastCheck, ping, pingLastCheck, http, httpLastCheck FROM oldDomains");
