...
db.sRun("INSERT INTO domains(name, dnsState, dnsLastUpdate, pingState, pingLastUpdate, httpState, httpLastUpdate) SELECT name, dns, dnsLastUpdate, ping, pingLastUpdate, http, httpLastUpdate FROM oldDomains");
